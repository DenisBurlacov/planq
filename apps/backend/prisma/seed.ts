...
async function main() {
  ...
  const productData = [
    // Living Room (6)
    {
      ...
      images: [
        'https://picsum.photos/seed/nordic-sofa-1/600/400',
        'https://picsum.photos/seed/nordic-sofa-2/600/400',
      ],
      rating: 4.5,
      reviewCount: 23,
    },
    {
      ...
      stock: 30,
      categoryId: livingRoom.id,
      images: ['https://picsum.photos/seed/coffee-table-1/600/400'],
      rating: 4.2,
      reviewCount: 15,
    },
    {
      ...
      categoryId: livingRoom.id,
      images: [
        'https://picsum.photos/seed/floor-lamp-1/600/400',
        'https://picsum.photos/seed/floor-lamp-2/600/400',
      ],
      rating: 4.8,
      reviewCount: 42,
    },
    {
      ...
      stock: 8,
      categoryId: livingRoom.id,
      images: ['https://picsum.photos/seed/bookshelf-1/600/400'],
      rating: 4.0,
      reviewCount: 7,
    },
    {
      ...
      stock: 15,
      categoryId: livingRoom.id,
      images: ['https://picsum.photos/seed/rug-1/600/400'],
      rating: 4.6,
      reviewCount: 19,
    },
    // Edge case: very long name
    {
      ...
      categoryId: livingRoom.id,
      images: [
        'https://picsum.photos/seed/sectional-1/600/400',
        'https://picsum.photos/seed/sectional-2/600/400',
        'https://picsum.photos/seed/sectional-3/600/400',
      ],
      rating: 5.0,
      reviewCount: 2,
    },
    ...
    // Bedroom (5)
    {
      ...
      images: [
        'https://picsum.photos/seed/bed-queen-1/600/400',
        'https://picsum.photos/seed/bed-queen-2/600/400',
      ],
      rating: 4.7,
      reviewCount: 31,
    },
    {
      ...
      stock: 25,
      categoryId: bedroom.id,
      images: ['https://picsum.photos/seed/bedside-1/600/400'],
      rating: 4.3,
      reviewCount: 12,
    },
    {
      ...
      categoryId: bedroom.id,
      images: [
        'https://picsum.photos/seed/wardrobe-1/600/400',
        'https://picsum.photos/seed/wardrobe-2/600/400',
      ],
      rating: 4.1,
      reviewCount: 9,
    },
    {
      ...
      stock: 14,
      categoryId: bedroom.id,
      images: ['https://picsum.photos/seed/dresser-1/600/400'],
      rating: 4.4,
      reviewCount: 18,
    },
    // Edge case: no images
    ...
    // Kitchen (5)
    {
      ...
      images: [
        'https://picsum.photos/seed/dining-table-1/600/400',
        'https://picsum.photos/seed/dining-table-2/600/400',
      ],
      rating: 4.6,
      reviewCount: 27,
    },
    {
      ...
      stock: 18,
      categoryId: kitchen.id,
      images: ['https://picsum.photos/seed/dining-chair-1/600/400'],
      rating: 4.3,
      reviewCount: 34,
    },
    {
      ...
      stock: 7,
      categoryId: kitchen.id,
      images: ['https://picsum.photos/seed/kitchen-island-1/600/400'],
      rating: 4.5,
      reviewCount: 11,
    },
    {
      ...
      stock: 50,
      categoryId: kitchen.id,
      images: ['https://picsum.photos/seed/wall-shelf-1/600/400'],
      rating: 4.1,
      reviewCount: 22,
    },
    // Edge case: stock 0
    {
      ...
      stock: 0,
      categoryId: kitchen.id,
      images: ['https://picsum.photos/seed/bar-stool-1/600/400'],
      rating: 3.9,
      reviewCount: 8,
    },
    ...
    // Bathroom (5)
    {
      ...
      images: ['https://picsum.photos/seed/bathroom-cabinet-1/600/400'],
      rating: 4.2,
      reviewCount: 16,
    },
    {
      ...
      stock: 40,
      categoryId: bathroom.id,
      images: ['https://picsum.photos/seed/towel-rack-1/600/400'],
      rating: 4.0,
      reviewCount: 29,
    },
    {
      ...
      stock: 35,
      categoryId: bathroom.id,
      images: ['https://picsum.photos/seed/laundry-basket-1/600/400'],
      rating: 4.4,
      reviewCount: 21,
    },
    {
      ...
      stock: 60,
      categoryId: bathroom.id,
      images: ['https://picsum.photos/seed/shower-shelf-1/600/400'],
      rating: 4.7,
      reviewCount: 45,
    },
    {
      ...
      stock: 16,
      categoryId: bathroom.id,
      images: ['https://picsum.photos/seed/vanity-stool-1/600/400'],
      rating: 4.6,
      reviewCount: 13,
    },
    ...
    // Office (5)
    {
      ...
      images: [
        'https://picsum.photos/seed/standing-desk-1/600/400',
        'https://picsum.photos/seed/standing-desk-2/600/400',
      ],
      rating: 4.8,
      reviewCount: 38,
    },
    {
      ...
      categoryId: office.id,
      images: [
        'https://picsum.photos/seed/office-chair-1/600/400',
        'https://picsum.photos/seed/office-chair-2/600/400',
      ],
      rating: 4.9,
      reviewCount: 67,
    },
    {
      ...
      stock: 55,
      categoryId: office.id,
      images: ['https://picsum.photos/seed/monitor-stand-1/600/400'],
      rating: 4.3,
      reviewCount: 24,
    },
    {
      ...
      stock: 20,
      categoryId: office.id,
      images: ['https://picsum.photos/seed/filing-cabinet-1/600/400'],
      rating: 3.7,
      reviewCount: 5,
    },
    // Edge case: lowest rating
    {
      ...
      stock: 200,
      categoryId: office.id,
      images: ['https://picsum.photos/seed/desk-organizer-1/600/400'],
      rating: 1.0,
      reviewCount: 3,
    },
    ...
    // Outdoor (4)
    {
      ...
      images: [
        'https://picsum.photos/seed/garden-set-1/600/400',
        'https://picsum.photos/seed/garden-set-2/600/400',
      ],
      rating: 4.5,
      reviewCount: 14,
    },
    {
      ...
      stock: 30,
      categoryId: outdoor.id,
      images: ['https://picsum.photos/seed/bistro-table-1/600/400'],
      rating: 4.2,
      reviewCount: 20,
    },
    {
      ...
      stock: 11,
      categoryId: outdoor.id,
      images: ['https://picsum.photos/seed/bench-1/600/400'],
      rating: 4.4,
      reviewCount: 9,
    },
    {
      ...
      stock: 25,
      categoryId: outdoor.id,
      images: ['https://picsum.photos/seed/planter-1/600/400'],
      rating: 4.1,
      reviewCount: 17,
    },
  ];
