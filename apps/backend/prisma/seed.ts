...
async function main() {
  ...
  const productData = [
    // Living Room (6)
    {
      ...
      images: ['/images/products/nordic-sofa-1.jpg', '/images/products/nordic-sofa-2.jpg'],
      rating: 4.5,
      reviewCount: 23,
    },
    {
    ...
    },
    {
      ...
      stock: 45,
      categoryId: livingRoom.id,
      images: ['/images/products/floor-lamp-1.jpg', '/images/products/floor-lamp-2.jpg'],
      rating: 4.8,
      reviewCount: 42,
    },
    {
    ...
    // Edge case: very long name
    {
      ...
      images: [
        ...
        '/images/products/sectional-2.jpg',
        '/images/products/sectional-3.jpg',
      ],
      rating: 5.0,
      reviewCount: 2,
    },
    ...
    // Bedroom (5)
    {
      ...
      images: ['/images/products/bed-queen-1.jpg', '/images/products/bed-queen-2.jpg'],
      rating: 4.7,
      reviewCount: 31,
    },
    {
      ...
      stock: 25,
      categoryId: bedroom.id,
      images: ['/images/products/bedside-1.jpg'],
      rating: 4.3,
      reviewCount: 12,
    },
    {
      ...
      stock: 6,
      categoryId: bedroom.id,
      images: ['/images/products/wardrobe-1.jpg', '/images/products/wardrobe-2.jpg'],
      rating: 4.1,
      reviewCount: 9,
    },
    {
    ...
    // Kitchen (5)
    {
      ...
      images: ['/images/products/dining-table-1.jpg', '/images/products/dining-table-2.jpg'],
      rating: 4.6,
      reviewCount: 27,
    },
    {
    ...
    },
    {
      ...
      stock: 7,
      categoryId: kitchen.id,
      images: ['/images/products/kitchen-island-1.jpg'],
      rating: 4.5,
      reviewCount: 11,
    },
    {
      ...
      stock: 50,
      categoryId: kitchen.id,
      images: ['/images/products/wall-shelf-1.jpg'],
      rating: 4.1,
      reviewCount: 22,
    },
    // Edge case: stock 0
    {
      ...
      stock: 0,
      categoryId: kitchen.id,
      images: ['/images/products/bar-stool-1.jpg'],
      rating: 3.9,
      reviewCount: 8,
    },
    ...
    // Bathroom (5)
    {
      ...
      images: ['/images/products/bathroom-cabinet-1.jpg'],
      rating: 4.2,
      reviewCount: 16,
    },
    {
      ...
      stock: 40,
      categoryId: bathroom.id,
      images: ['/images/products/towel-rack-1.jpg'],
      rating: 4.0,
      reviewCount: 29,
    },
    {
      ...
      stock: 35,
      categoryId: bathroom.id,
      images: ['/images/products/laundry-basket-1.jpg'],
      rating: 4.4,
      reviewCount: 21,
    },
    {
      ...
      stock: 60,
      categoryId: bathroom.id,
      images: ['/images/products/shower-shelf-1.jpg'],
      rating: 4.7,
      reviewCount: 45,
    },
    {
      ...
      stock: 16,
      categoryId: bathroom.id,
      images: ['/images/products/vanity-stool-1.jpg'],
      rating: 4.6,
      reviewCount: 13,
    },
    ...
    // Office (5)
    {
      ...
      images: ['/images/products/standing-desk-1.jpg', '/images/products/standing-desk-2.jpg'],
      rating: 4.8,
      reviewCount: 38,
    },
    {
    ...
    },
    {
      ...
      stock: 20,
      categoryId: office.id,
      images: ['/images/products/filing-cabinet-1.jpg'],
      rating: 3.7,
      reviewCount: 5,
    },
    ...
    // Outdoor (4)
    {
      ...
      images: ['/images/products/garden-set-1.jpg', '/images/products/garden-set-2.jpg'],
      rating: 4.5,
      reviewCount: 14,
    },
    {
      ...
      stock: 30,
      categoryId: outdoor.id,
      images: ['/images/products/bistro-table-1.jpg'],
      rating: 4.2,
      reviewCount: 20,
    },
    {
      ...
      stock: 11,
      categoryId: outdoor.id,
      images: ['/images/products/bench-1.jpg'],
      rating: 4.4,
      reviewCount: 9,
    },
    {
