...
- [x] Этап 6 — CI/CD ✅
- [x] Этап 7 — Мониторинг ✅
- [ ] Этап 8 — UI + Контент (расширен 2026-03-30)
...
**Этап 8 — UI + Контент** Расширенный скоуп зафиксирован командой (2026-03-30):
...
_В работе (8.2):_
- Seed: +4 категории (Декор, Текстиль, Освещение, Хранение), 60-80 товаров с нормальными фото мебели/интерьера (Unsplash)
- HomePage: Hero-баннер с CTA + секции «Новинки» и «Хиты продаж» + плитка категорий
- ProductPage: галерея фото + аккордеон «Характеристики»
- Hover на карточке товара: scale + кнопка «Быстрый просмотр»
- Breadcrumb на ProductPage и CheckoutPage
- Tooltip на кнопке «В избранное»
- NavBar: data-testid на всех элементах навигации
- 404 страница с data-testid

_QA-аудит:_ LOCATORS.md — полный список всех data-testid проекта (есть намеренно / нет намеренно).

⚠️ _Урок: фото в seed критичны для восприятия — без нормальных изображений дизайн не работает. Backend инициатива: использовать тематические Unsplash URL для мебели/декора._
